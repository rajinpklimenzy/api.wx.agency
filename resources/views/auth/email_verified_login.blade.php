                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="{{ route('email/password/update') }}" novalidate>
                                            @csrf
                                            <input type="hidden" name="token" value="{{ $email }}" >
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control" id="user-name" placeholder="email" name="email" value="{{$email}}" required>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="password" class="form-control" id="password-confirmd" name="password_confirmation" placeholder="Confirm Password" required>
                                                <div class="form-control-position">
                                                    <i class="fa fa-key"></i>
                                                </div>
