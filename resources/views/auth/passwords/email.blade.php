...
<body class="horizontal-layout horizontal-menu 1-column  bg-full-screen-image blank-page blank-page  pace-done" data-open="hover" data-menu="horizontal-menu" data-col="1-column">
    <!-- BEGIN: Content-->
                            ...
                            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                <div class="card-header border-0 pb-0">
                                    <div class="card-title text-center">
                                        <img src="https://d1myhw8pp24x4f.cloudfront.net/company_logo/1572015127311_b_163.png" width="60" alt="branding logo">
                                    </div>
